...
public class InventoryForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Spinner Ice Cream Shop");

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\GIGABYTE\\Downloads\\iceam.png")); // NOI18N
        jLabel2.setText("jLabel2");

        jLabel3.setFont(new java.awt.Font("Bookman Old Style", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 51, 204));
        jLabel3.setText("Spinner");

        Percent.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        Percent.setForeground(new java.awt.Color(255, 0, 153));
        Percent.setText("        %");
    ...
    InventoryForm loading=new InventoryForm();
    loading.setVisible(true);
    try{
    for(int i=0;i<=100;i++){
        Thread.sleep(35);
        loading.Progress.setValue(i);
        loading.Percent.setText(Integer.valueOf(i) + "%");
        }
        }catch(Exception e){
